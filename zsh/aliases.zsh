...
alias scm='ssh -X -A -C -L8889:localhost:8889 -i ~/.ssh/mice2_ec2.pub dattalab@$(sci)'
alias scm-whetlab='ssh -X -A -C -L8899:localhost:8899 -i ~/.ssh/whetlabkey.pem whetlab@$(sci)'
alias zh='cd $HOME'
